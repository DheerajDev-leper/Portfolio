...
from django.core.mail import EmailMessage # Keep it here cleanly
...
def contact(request):
    ...
    if not all([first_name, last_name, email, subject, message]):
        return JsonResponse({'status': 'error', 'message': 'Please fill in all fields before submitting.'}, status=400)
